This is a plugin for ImageJ and or Fiji

It is intended as an ideal starting point to develop a framework for the
detection of markers used in Kinematic recordings
